...
def linear_regression(X, y, validate=True):
    ...
    validate : bool, optional
        If True, validates the input data to ensure it does not contain
        infinite or NaN values, has at least two unique values, and is full rank.
...
# Verbose version of the simple linear regression function generated by Copilot
