...
python src/BetterCodeBetterScience/rnaseq/immune_scrnaseq_monolithic.py
```
...
```bash
jupyter notebook src/BetterCodeBetterScience/rnaseq/immune_scrnaseq_monolithic.py
```
...
export DATADIR=/path/to/your/data
python -m BetterCodeBetterScience.rnaseq.modular_workflow.run_workflow

# Or import and run programmatically
python -c "
from pathlib import Path
from BetterCodeBetterScience.rnaseq.modular_workflow.run_workflow import run_full_workflow
...
export DATADIR=/path/to/your/data
python -m BetterCodeBetterScience.rnaseq.stateless_workflow.run_workflow
```
...
```python
from pathlib import Path
from BetterCodeBetterScience.rnaseq.stateless_workflow.run_workflow import (
...
python -m BetterCodeBetterScience.rnaseq.prefect_workflow.run_workflow --datadir /path/to/data/immune_aging
...
```bash
cd src/BetterCodeBetterScience/rnaseq/snakemake_workflow
