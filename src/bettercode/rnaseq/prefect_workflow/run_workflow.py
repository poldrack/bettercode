...
Or with arguments:
    python -m bettercode.rnaseq.prefect_workflow.run_workflow --force-from 8

With custom config:
    python -m bettercode.rnaseq.prefect_workflow.run_workflow --config /path/to/config.yaml
"""
...
from bettercode.rnaseq.prefect_workflow.flows import (
